...
if (is_numeric($nik))
{
    if ($nik != '' AND $digitnik < 16)
    {
        header("location:index.php?pasien=$pasien&tipe=$tipe&pesan=nikkurang");
    }
    else
    {
//Proses Bridging
    ...
    curl_setopt_array($curl, array(
      //Pakai NIK
      CURLOPT_URL => 'https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/Peserta/nik/'.$nik.'/tglSEP/'.$tgl,
