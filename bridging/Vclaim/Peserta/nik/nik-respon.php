...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://apijkn-dev.bpjs-kesehatan.go.id/vclaim-rest-dev/Peserta/nik/7173021212850001/tglSEP/2023-02-03',
...
$result['peserta'] = json_decode($content, true);
foreach ($result['peserta'] as $value) {

    echo "<hr>" . "Nama : " . $value['nama'] . "<br>";
    echo "No. Kartu : " . $value['noKartu'] . "<br>";
    echo "NIK : " . $value['nik'] . "<br>";
    echo "Tanggal Lahir : " . $value['tglLahir'];
    echo "<br>" . "Umur Sekarang : " . $value['umur']['umurSekarang'];
...
$umurSekarang = $value['umur']['umurSekarang'];


$connect = mysqli_connect("localhost", "root", "", "bridgingbpjs_db");
$save = mysqli_query($connect,"INSERT INTO tb_nik VALUES ('','$nama','$noKartu', '$nik', '$tglLahir','$umurSekarang')");
